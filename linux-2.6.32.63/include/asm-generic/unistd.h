...
#define __NR_doeventopen 181			/*new system call: doeventopen*/
__SYSCALL(__NR_doeventopen, sys_doeventopen)
#define __NR_doeventclose 182			/*new system call: doeventclose*/
__SYSCALL(__NR_doeventclose, sys_doeventclose)
#define __NR_doeventwait 183			/*new system call: doeventwait*/
__SYSCALL(__NR_doeventwait, sys_doeventwait)
#define __NR_doeventsig 184				/*new system call: doeventsig*/
__SYSCALL(__NR_doeventsig, sys_doeventsig)
#define __NR_doeventinfo 185			/*new system call: doeventinfo*/
...
#define __NR_doeventchown 205			/*new system call: doeventchown*/
...
#define __NR_doeventchmod 211		/*new system call: doeventchmod*/
...
#define __NR_doeventstat 214		/*new system call: doeventstat*/
